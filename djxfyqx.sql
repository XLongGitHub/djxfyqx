...
CREATE TABLE `qx_settlement` (
    ...
    `sum_material_cost_discount` VARCHAR(255) COMMENT '',
    `sum_manage_cost` VARCHAR(255) COMMENT '',
    `sum_hourly_wage_cost` VARCHAR(255) COMMENT '',
    `sum_hourly_wage_cost_discount` VARCHAR(255) COMMENT '',
    `accessories_cost` VARCHAR(255) COMMENT '',
    `outer_process_cost` VARCHAR(255) COMMENT '',
    `other_cost` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_material` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_material_discount` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_hourly` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_hourly_discount` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_cost` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_discount` VARCHAR(255) COMMENT '',
    `three_packs_or_accident_should_pay` VARCHAR(255) COMMENT '',
    `sum_common_cost` VARCHAR(255) COMMENT '',
    `sum_common_discount` VARCHAR(255) COMMENT '',
    `car_owner_should_pay` VARCHAR(255) COMMENT '',
    `pay_in_advance` VARCHAR(255) COMMENT '',
    `should_pay_in_chinese` VARCHAR(255) COMMENT '',
    `car_owner_receipt` VARCHAR(255) COMMENT '',
    `car_owner_arrears` VARCHAR(255) COMMENT '',
    `remark` VARCHAR(255) COMMENT '',
    `pay_method` VARCHAR(255) COMMENT '',
    `customer_signature` VARCHAR(255) COMMENT '',
